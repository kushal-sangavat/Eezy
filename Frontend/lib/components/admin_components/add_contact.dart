...
//                       ),
//                       Text('Back to Contact Directory', style: TextStyle(
//                         color: const Color.fromARGB(255, 3, 59, 105),
//                         fontSize: 15,
...
//                     child: Text('Add New Contact', style: TextStyle(
//                       color: const Color.fromARGB(255, 3, 59, 105),
//                       fontSize: 22,
//                       fontWeight: FontWeight.bold,
//                     ),
...
//             group: departmentController.text.trim(), // group can be department
//           );

//           bool success = await addContact(newContact);
...
//             SizedBox(width: 10),
//             Text('Save Contact', style: TextStyle(
//               color: Colors.white,
//               fontSize: 16,
//               fontWeight: FontWeight.bold,
//             ),
